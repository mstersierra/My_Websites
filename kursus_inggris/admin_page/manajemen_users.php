<?php 
  ...
  session_cache_limiter(false);
	...
	if(isset($_POST["searchBtn"])) :
		$tables = search_users($_POST["search"]);
	else :
		$tables = query("SELECT * FROM login ORDER BY status");
	endif;
	...
	<div class="wrapper">
            ...
            <nav id="sidebar">
                ...
                <ul class="list-unstyled components">
                    ...
                    <li>
                        <a href="../logout.php" aria-expanded="false" onclick="return confirm('Are you sure to logout?')"><span class="fa fa-sign-out fa-fw"></span> Logout</a>
                    </li>   
                </ul>
                <ul class="list-unstyled components">
                	<li>
            ...
            <div id="content">
                ...
                <div class="text-center" style="margin-bottom: 30px;">
                	<h1><span class="fa fa-user fa-fw"></span> Users Management</h1>
                </div>
                	...
                	<table class="table table-sm table-hover table-bordered">
                		<thead class="">
                			<tr>
                				...
                				<th class="bg-warning text-center" scope="col">Username</th>
                				<th class="bg-success text-center" scope="col">Account Name</th>
                				<th class="bg-info text-center" scope="col">E-mail</th>
                				<th class="bg-primary text-center" scope="col">Password</th>
                				<th class="table-active text-center" scope="col">Status</th>
                		...
                		<?php foreach ($tables as $u) : ?>
                			<tr>
                				...
                				<td class="text-center"><?= str_repeat("*", strlen($u["password"])); ?></td>
                				<td class="text-center"><?= $u["status"]; ?></td>
                				<td class="text-center">
                                    <a class="badge badge-primary" href="update_users.php?username=<?= $u["username"]; ?>">Update </a> |
                                    <a class="badge badge-danger" href="delete_users.php?username=<?= $u["username"]; ?>" onclick="return confirm('Are you sure to delete this?');">Delete</a>
                                </td>
                			</tr> 
                		<?php $i++; endforeach; ?>
