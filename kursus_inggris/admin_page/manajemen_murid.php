<?php 
  ...
  session_cache_limiter(false);
	...
	if(isset($_POST["searchBtn"])) :
		$tables = search_student($_POST["search"]);
	else :
		$tables = query("SELECT * FROM murid ORDER BY id_kelas");
	endif;
	...
	<div class="wrapper">
            ...
            <div id="content">
                ...
                <div class="text-center" style="margin-bottom: 30px;">
                	<h1><span class="fa fa-address-card-o fa-fw"></span> Students Management</h1>
                </div>
                	...
                	<table class="table table-sm table-hover table-bordered">
                		<thead class="">
                			<tr>
                                ...
                                <th class="bg-warning text-center" scope="col">Student Picture</th>
                				<th class="bg-success text-center" scope="col">Username</th>
                				<th class="bg-info text-center" scope="col">Student Name</th>
                				<th class="bg-primary text-center" scope="col">Class</th>
                				<th class="bg-info text-center" scope="col">E-mail</th>
                				<th class="bg-success text-center" scope="col">Address</th>
                				<th class="bg-warning text-center" scope="col">Telephone No</th>
                				<th class="bg-danger text-center"><a href="">Edit</a></th>
                			</tr>
                		</thead>
                		<?php $i=1; ?>
                		<?php foreach ($tables as $u) : ?>
                			<tr>
                                ...
                                <td class="text-center"><img src="student_photos/<?= $u["photo"]; ?>" width=30></td>
                				<td class="text-center"><?= $u["username"]; ?></td>
                				<td class="text-center"><?= $u["nama_murid"]; ?></td>
                				<td class="text-center"><?= $u["id_kelas"]; ?></td>
                				<td class="text-center"><?= $u["email"]; ?></td>
                				<td class="text-center"><?= $u["alamat"]; ?></td>
                				<td class="text-center"><?= $u["notelp"]; ?></td>
                				<td class="text-center">
                                    <a class="badge badge-primary" href="update_murid.php?username=<?= $u["username"]; ?>">Update </a> | 
                                    <a class="badge badge-danger" href="delete_murid.php?username=<?= $u["username"]; ?>" onclick="return confirm('Are you sure to delete this?');">Delete</a>
                                </td>
                			</tr> 
                		<?php $i++; endforeach; ?>
