<?php 
  ...
  session_cache_limiter(false);
	...
	if(isset($_POST["searchBtn"])) :
		$tables = search_material($_POST["search"]);
	else :
		$tables = query("SELECT * FROM materi ORDER BY id_kelas");
	endif;
	...
	<div class="wrapper">
            ...
            <div id="content">
                ...
                <div class="text-center" style="margin-bottom: 30px;">
                	<h1><span class="fa fa-book fa-fw"></span> Materials Management</h1>
                </div>
                	...
                	<table class="table table-sm table-hover table-bordered">
                		<thead class="">
                			<tr>
                                ...
                                <th class="bg-warning text-center" scope="col">Material ID</th>
                				<th class="bg-success text-center" scope="col">Class</th>
                				<th class="bg-primary text-center" scope="col">Material Name</th>
                				<th class="bg-danger text-center" scope="col">File Name</th>
                		...
                		<?php foreach ($tables as $u) : ?>
                			<tr>
                                ...
                                <td class="text-center"><?= $u["id_materi"]; ?></td>
                				<td class="text-center"><?= $u["id_kelas"]; ?></td>
                				<td class="text-center"><?= $u["nama_materi"]; ?></td>
                				<td class="text-center"><a class="badge badge-primary" href="materials/<?= $u["file_materi"]; ?>" download="<?= $u["nama_file"]; ?>" ><?= $u["nama_file"]; ?></a></td>
                				<td class="text-center">
                                    <a class="badge badge-primary" href="update_materi.php?id_materi=<?= $u["id_materi"]; ?>">Update </a> |
                                    <a class="badge badge-danger" href="delete_materi.php?id_materi=<?= $u["id_materi"]; ?>" onclick="return confirm('Are you sure to delete this?');">Delete</a>
                                </td>
                			</tr> 
                		<?php $i++; endforeach; ?>
