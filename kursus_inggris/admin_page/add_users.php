...
<body>
	...
	<div class="wrapper">
            ...
            <div id="content">
                ...
                <h3><span class="fa fa-user fa-fw"></span> Add User</h3>
                ...
                <form action="" method="post" id="formm">
                    ...
                    <button class="btn btn-primary" name="submit" id="submit" onclick="return confirm('Are you sure?')"><span class="fa fa-plus fa-fw"></span> Add User</button>
                </form>
